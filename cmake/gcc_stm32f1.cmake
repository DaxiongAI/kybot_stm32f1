if(${USE_WHICH_COMPILER} STREQUAL "win_keil")
        SET(CMAKE_C_FLAGS "--cpu Cortex-M3 -g -O0 --apcs=interwork --c99 " CACHE INTERNAL "c compiler flags")
        SET(CMAKE_CXX_FLAGS "--cpu Cortex-M3 -g -O0 --apcs=interwork --c99 " CACHE INTERNAL "cxx compiler flags")
        SET(CMAKE_ASM_FLAGS "--cpu Cortex-M3 -g --apcs=interwork --c99 " CACHE INTERNAL "asm compiler flags")

        SET(CMAKE_EXE_LINKER_FLAGS "--cpu Cortex-M3" CACHE INTERNAL "executable linker flags")
        SET(CMAKE_MODULE_LINKER_FLAGS "--cpu Cortex-M3" CACHE INTERNAL "module linker flags")
        SET(CMAKE_SHARED_LINKER_FLAGS "--cpu Cortex-M3" CACHE INTERNAL "shared linker flags")
else()
        ...
        SET(CMAKE_EXE_LINKER_FLAGS "-Wl,--gc-sections -mthumb -mcpu=cortex-m3 --specs=nosys.specs -mabi=aapcs" CACHE INTERNAL "executable linker flags")
...
SET(STM32_CHIP_TYPES 100xB 100xE 101x6 101xB 101xE 101xG 102x6 102xB 103x6 103x8 103xB 103xE 103xG 105xC 107xC CACHE INTERNAL "stm32f1 chip types")
SET(STM32_CODES "100.[468B]" "100.[CDE]" "101.[46]" "101.[8B]" "101.[CDE]" "101.[FG]" "102.[46]" "102.[8B]" "103.[46]" "103.[8]" "103.[B]" "103.[CDE]" "103.[FG]" "105.[8BC]" "107.[BC]")
